...
//--------------------------------------------------------------------
{
    ...
    if (vitesse > 0) {
        ...
        if (Mx_Sens >= 0) {
            Vit_M1 = VCOMPAR_1P5MS;             // Mot_G arret
            Vit_M2 = VCOMPAR_1P5MS - vitesse;   // Mot_D avance
        }
        else {
            Vit_M1 = VCOMPAR_1P5MS;             // Mot_G arret
            Vit_M2 = VCOMPAR_1P5MS + vitesse;   // Mot_D recule
        }
        Motor_Pwm_Speed();
    }
}
...
//--------------------------------------------------------------------
{
    ...
    if (vitesse > 0) {
        ...
        vitesse = vitesse * DELTA_VIT;
        if (Mx_Sens >= 0) {
            Vit_M1 = VCOMPAR_1P5MS + vitesse;   // Mot_G avance
            Vit_M2 = VCOMPAR_1P5MS;             // Mot_D arret
        }
        else {
            Vit_M1 = VCOMPAR_1P5MS - vitesse;   // Mot_G recule
            Vit_M2 = VCOMPAR_1P5MS;             // Mot_D arret
        }
        Motor_Pwm_Speed();
    }
